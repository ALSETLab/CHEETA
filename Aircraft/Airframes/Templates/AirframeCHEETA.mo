...
model AirframeCHEETA "CHEETA airframe"
  extends AircraftDynamics.Aircraft.Airframes.Shevell(
    redeclare Wings.Examples.CHEETA                                         wing(
      prescribeSref=false,
      ar=ar,
      prescribeAr=true,
      sweep=sweep,
    ...
    redeclare Fuselages.Examples.CHEETA                                         fuselage(n_coachseats=n_coachseats, wingxposition=0.487),
    redeclare Tails.Examples.CHEETA                                         tail,
  ...
  parameter Modelica.SIunits.Angle sweep=Modelica.SIunits.Conversions.from_deg(24.5) "Quarter chord sweep" annotation (Dialog(tab="Airframe"));
  ...
  parameter Modelica.SIunits.Angle wingdihedral=Modelica.SIunits.Conversions.from_deg(4.0) "Dihedral" annotation (Dialog(tab="Airframe"));
  ...
  parameter Modelica.SIunits.Distance span=Modelon.Units.Conversions.from_ft(150.0) "Span" annotation (Dialog(tab="Airframe"));
