...
model CRJ700 "CRJ700 tail"
  extends AircraftDynamics.Aircraft.Airframes.Tails.Shevell(
    svOverSref=0.161,
    arv=1.1,
    sweepv=Modelica.Units.Conversions.from_deg(43.5),
    tovercv=0.11,
    taperv=0.8016,
    shOverSref=0.26,
    arh=4.928,
    sweeph=Modelica.Units.Conversions.from_deg(31.6),
    toverch=0.087,
    taperh=0.352,
    hasTeeTail=0.98,
    dihedralh=Modelica.Units.Conversions.from_deg(-3.0),
    clhmax=1.2,
