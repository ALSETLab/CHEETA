...
model BatteryDischarge "Scaled battery pack with imposed electrical power"
  import Battery;
 ...
 parameter Modelica.Units.SI.Temperature T_test0=273.15 "Test temperature";
  ...
  Modelica.Electrical.Analog.Sources.ConstantCurrent constantCurrent1(I=5)
                                                             annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
  ...
  Modelica.Electrical.Analog.Sources.ConstantCurrent constantCurrent2(I=5)
                                                             annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
...
equation
  ...
  connect(constantCurrent2.n, ground2.p) annotation (Line(points={{106,-48},{
          106,-68},{120,-68},{120,-78}}, color={0,0,255}));
