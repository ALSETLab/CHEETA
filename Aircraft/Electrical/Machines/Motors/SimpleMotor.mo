...
model SimpleMotor "Simplified AC motor model"
  ...
  parameter Modelica.Units.SI.Frequency f=300 "Machine frequency";
  ...
  Modelica.Units.SI.CurrentDensity J_c=1780 "Critical current density";
  Modelica.Units.SI.Diameter D_o=0.32e-3 "SC outer diameter";
  Modelica.Units.SI.Diameter d_f=0.01e-3 "Filament diameter";
  Real n = 114 "Number of filanments";
  Real lambda = 0.15 "SC fill factor";
  Real lambda_e = 0.49 "Effective fill factor";
  Modelica.Units.SI.Resistivity rho=3.65e-4 "Transverse resistivity";
  Modelica.Units.SI.Resistivity rho_e=1.25e-4
    "Effective transverse resistivity";
  Modelica.Units.SI.Length L=5e-3 "Twist pitch";
