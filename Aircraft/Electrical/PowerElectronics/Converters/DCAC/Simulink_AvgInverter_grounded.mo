...
model Simulink_AvgInverter_grounded
  ...
  Modelica.Electrical.Analog.Interfaces.PositivePin pin_p annotation (
      Placement(transformation(extent={{-140,-8},{-120,12}}),
        iconTransformation(extent={{-140,-8},{-120,12}})));
  ...
  Modelica.Electrical.Analog.Interfaces.NegativePin pin_n1 annotation (
      Placement(transformation(extent={{-140,-186},{-120,-166}}),
        iconTransformation(extent={{-140,-186},{-120,-166}})));
  Modelica.Electrical.Analog.Basic.Ground ground2 annotation (Placement(
        transformation(extent={{-102,-94},{-82,-74}})));
...
equation
  ...
  connect(pin_p, pin_p) annotation (Line(points={{-130,2},{-114,2},{-114,2},{
          -130,2}},            color={0,0,255}));
  connect(pin_p, Ipa.p)
    annotation (Line(points={{-130,2},{-82,2},{-82,68},{-32,68}},
                                                  color={0,0,255}));
  connect(pin_p1, pin_n) annotation (Line(points={{-130,-110},{-130,-64},{-130,
          -70},{-130,-70}},
        color={0,0,255}));
  connect(ground2.p, pin_n) annotation (Line(points={{-92,-74},{-112,-74},{-112,
          -22},{-130,-22},{-130,-70}},            color={0,0,255}));
  connect(pin_n1, Ina.p) annotation (Line(points={{-130,-176},{-130,20},{-30,20}},
                     color={0,0,255}));
  ...
  connect(pin_p, Ipa1.p) annotation (Line(points={{-130,2},{-74,2},{-74,-26},{
          -30,-26}},           color={0,0,255}));
  connect(pin_n1, Ina1.p) annotation (Line(points={{-130,-176},{-28,-176},{-28,
          -72}},            color={0,0,255}));
  connect(pin_n1, Ina.p) annotation (Line(points={{-130,-176},{-30,-176},{-30,
          20}},      color={0,0,255}));
  ...
  connect(pin_p, Ipa2.p) annotation (Line(points={{-130,2},{-74,2},{-74,-132},{
          -30,-132}},            color={0,0,255}));
  connect(pin_n1, Ina2.p) annotation (Line(points={{-130,-176},{-28,-176},{-28,
          -178}},            color={0,0,255}));
  ...
  annotation (
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-120,-200},{140,
            20}}), graphics={
        Rectangle(extent={{-68,-6},{92,-166}},lineColor={28,108,200}),
                                Rectangle(
        extent={{-120,-206},{140,34}},
        lineColor={0,0,127},
        fillColor={255,255,255},
        fillPattern=FillPattern.Solid),
        Line(
          points={{-120,-206},{140,34}},
          color={0,0,127}),
        Rectangle(
          extent={{-28,-46},{52,-126}},
        ...
        Line(
          ...
          color={0,0,255}),
        Line(
          points={{-8,-82},{12,-62},{12,-46}},
          color={0,0,255}),
        Line(
          points={{-8,-90},{12,-110},{12,-126}},
          color={0,0,255}),
        Line(
          points={{8,-106},{2,-94},{-4,-100},{8,-106}},
          color={0,0,255}),
        Line(
          points={{12,-110},{22,-110},{22,-62},{12,-62}},
          color={0,0,255}),
        Line(
          points={{12,-78},{32,-78}},
          color={0,0,255}),
        Line(
          points={{22,-78},{12,-94},{32,-94},{22,-78}},
          color={0,0,255})}),
...
end Simulink_AvgInverter_grounded;
