...
model SineVI_R_load
  ...
  Modelica.Electrical.Analog.Sources.SineCurrent sineCurrent1(
    I=250,
    freqHz=60,
    offset=0.1)
    annotation (Placement(transformation(
  ...
  Modelica.Electrical.Analog.Sources.SineCurrent sineCurrent2(
    I=250,
    freqHz=60,
    offset=0.1)
    annotation (Placement(transformation(
...
equation
  ...
  connect(thermalConductor1.port_b,hTS_Piline3_2. port_a)
    annotation (Line(points={{-20,80},{-50,80},{-50,64}},
                                                      color={191,0,0}));
  connect(sineCurrent.n,hTS_Piline3_2. pin_p)
    annotation (Line(points={{-80,40},{-80,60},{-59,60}}, color={0,0,255}));
  connect(sineCurrent.p,ground2. p) annotation (Line(points={{-80,20},{-80,0},{
          -34,0}},         color={0,0,255}));
  ...
  connect(thermalConductor2.port_b,hTS_Piline3_1. port_a)
    annotation (Line(points={{116,82},{96,82},{96,64}},
                                                      color={191,0,0}));
  connect(sineCurrent1.n, hTS_Piline3_1.pin_p)
    annotation (Line(points={{60,40},{60,60},{87,60}}, color={0,0,255}));
  connect(sineCurrent1.p, ground1.p)
  ...
  connect(thermalConductor3.port_b,hTS_Piline3_3. port_a)
    annotation (Line(points={{266,82},{246,82},{246,64}},
                                                      color={191,0,0}));
  connect(sineCurrent2.n,hTS_Piline3_3. pin_p)
    annotation (Line(points={{210,40},{210,60},{237,60}},
                                                       color={0,0,255}));
  connect(sineCurrent2.p,ground3. p)
