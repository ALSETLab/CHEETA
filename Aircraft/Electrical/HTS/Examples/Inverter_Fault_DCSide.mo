...
model Inverter_Fault_DCSide
  ...
  Modelica.Mechanics.Rotational.Sources.ConstantTorque             load(
      tau_constant=-500)                  annotation (Placement(transformation(extent={{96,-48},
            {76,-28}})));
  ...
  Modelica.Blocks.Sources.Ramp ramp(
    ...
    offset=2000.25,
    startTime=10)
    annotation (Placement(transformation(extent={{-52,-22},{-44,-14}})));
equation
  ...
  connect(resistor1.R, ramp.y)
    annotation (Line(points={{-36,-18},{-43.6,-18}}, color={0,0,127}));
  connect(resistor1.p, electricDrive.pin_p)
    annotation (Line(points={{-24,-8},{-24,0},{4,0}}, color={0,0,255}));
  connect(resistor1.n, ground1.p)
    annotation (Line(points={{-24,-28},{-24,-32},{-10,-32}}, color={0,0,255}));
  annotation (Diagram(coordinateSystem(extent={{-100,-100},{100,60}})), Icon(
        coordinateSystem(extent={{-100,-100},{100,60}})),
    experiment(StopTime=100, __Dymola_Algorithm="Dassl"));
end Inverter_Fault_DCSide;
