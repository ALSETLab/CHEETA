...
model GasCooling
  ...
  GasCooled.HTS_GasCooling HTS(
    ...
    G_d=10,
    a(displayUnit="mm"),
    b(displayUnit="mm"))         annotation (Placement(transformation(extent={{-46,24},{-30,16}})));
  ...
  GasCooled.HTS_GasCooling_Voltage HTS1(
    ...
    T_c(displayUnit="K"),
    R_L=1e-6,
    G_d=0) annotation (Placement(transformation(extent={{102,10},{118,2}})));
equation
  connect(rampCurrent.p,ground2. p) annotation (Line(points={{-68,-34},{-68,-56},
          {-24,-56}},      color={0,0,255}));
  ...
  connect(HTS.pin_p, rampCurrent.n)
    annotation (Line(points={{-47,20},{-68,20},{-68,-14}}, color={0,0,255}));
  ...
  connect(resistor2.n,ground1. p)
    annotation (Line(points={{132,-36},{132,-60},{120,-60}},
                                                        color={0,0,255}));
  ...
  connect(HTS1.pin_n, resistor2.p)
    annotation (Line(points={{119,6},{132,6},{132,-16}}, color={0,0,255}));
