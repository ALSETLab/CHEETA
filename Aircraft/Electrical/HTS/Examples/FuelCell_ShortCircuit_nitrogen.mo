...
model FuelCell_ShortCircuit_nitrogen
  ...
  FuelCell.FuelCell_EquationBased_DetailedRohm
    ...
    E_0=1000,                            n=2,
    R_ohm0=0.15)
    annotation (Placement(transformation(extent={{-72,-6},{-58,8}})));
  ...
  LiquidCooled.HTS_filmboiling_Voltage_Nitrogen HTS(
    l=10,
    n=20,
    I_c0=3700,
    A=0.1,
...
equation
  ...
  connect(prescribedTemperature4.port, fuelCell_EquationBased_DetailedRohm1.port_a)
    annotation (Line(points={{-78,-30},{-65,-30},{-65,-6}},     color={191,0,0}));
  ...
  connect(fuelCell_EquationBased_DetailedRohm1.p1, HTS.pin_p) annotation (Line(
        points={{-58,1.7},{-58,0},{-40,0},{-40,20},{-29,20}},  color={0,0,255}));
  ...
  annotation (Diagram(coordinateSystem(extent={{-140,-60},{100,60}})),  Icon(
    ...
    __Dymola_Commands(file=
        ...
        "PlotFaults"));
end FuelCell_ShortCircuit_nitrogen;
