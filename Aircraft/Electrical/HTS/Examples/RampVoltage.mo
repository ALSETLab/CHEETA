...
model RampVoltage
  HTS_Piline4 hTS_Piline4_2(
    ...
    R_L=0.001,
    G_d=0,
    P=0.1) annotation (Placement(transformation(extent={{112,64},{128,56}})));
...
equation
  ...
  connect(thermalConductor1.port_b,hTS_Piline4_2. port_a)
    annotation (Line(points={{140,82},{120,82},{120,64}},
                                                        color={191,0,0}));
  connect(hTS_Piline4_2.pin_n,ground2. p) annotation (Line(points={{129,60},{
          138,60},{138,2},{126,2}},
                               color={0,0,255}));
  connect(rampVoltage1.p, hTS_Piline4_2.pin_p)
    annotation (Line(points={{80,48},{80,60},{111,60}}, color={0,0,255}));
  connect(rampVoltage1.n, ground2.p)
    annotation (Line(points={{80,28},{80,2},{126,2}}, color={0,0,255}));
  annotation (
