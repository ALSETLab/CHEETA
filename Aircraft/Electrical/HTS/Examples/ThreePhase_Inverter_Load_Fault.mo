...
model ThreePhase_Inverter_Load_Fault
  ...
  LiquidCooled.HTS_filmboiling_Voltage2 hTS_filmboiling3_1(
    ...
    a=0.1,
    b=0.5,
    P=1)  annotation (Placement(transformation(extent={{-50,2},{-34,10}})));
...
end ThreePhase_Inverter_Load_Fault;
