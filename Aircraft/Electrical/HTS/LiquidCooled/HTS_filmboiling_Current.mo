...
model HTS_filmboiling_Current "HTS line using Stekly equations"
  ...
  parameter Modelica.Units.SI.Area A=1 "Copper area per tape (ref. 2mm by 1mm)";
  ...
  Modelica.Units.SI.Length P "Perimeter of line";
  Modelica.Units.SI.Area A_cu "Area of copper in wire";
...
equation
  A_cu = A_cu_tape*n_Tape;
  P = b* Modelica.Constants.pi;
  mu = mu_0*mu_r;
