...
package Controls
  ...
  equation
    ...
    connect(TGR.u, feedback1.u2) annotation (Line(points={{-48,-50},{60,-50},{60,-22},
            {6,-22},{6,-6}}, color={0,0,127}));
    ...
    connect(TGR.y, SUM.u3) annotation (Line(points={{-71,-50},{-142,-50},{-142,-6},
            {-136,-6}}, color={0,0,127}));
