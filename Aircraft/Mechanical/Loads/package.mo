...
package Loads
  ...
  model Pinwheel
    ...
    Modelica.Mechanics.MultiBody.Joints.GearConstraint
      ...
      checkTotalPower=true)
                       annotation (Placement(transformation(extent={{6,32},{
              26,52}})));
    ...
    Modelica.Mechanics.MultiBody.Parts.Fixed
                fixed annotation (Placement(transformation(extent={{-48,-92},
              {-28,-72}})));
  ...
  parameter Modelica.Units.SI.Area A=2 "Frontal area of fan";
  ...
  Modelica.Units.SI.Force F_drag;
                   Real C_d = 5200
                    "Drag coefficient";
  Modelica.Units.SI.Velocity v_plane "Velocity of the plane";
  Modelica.Units.SI.Velocity v_wind "Velocity of the wind";
  Modelica.Units.SI.Velocity v "Total velocity";
  ...
  equation
    ...
    connect(fixed.frame_b,mounting1D. frame_a) annotation (Line(
        ...
        color={95,95,95},
        thickness=0.5));
    connect(vectorInput.y, torque1.torque) annotation (Line(points={{-56,80},{
          -50,80},{-50,54}},    color={0,0,127}));
  ...
  connect(inertia.flange_a, flange_a1) annotation (Line(points={{-76,-18},{-92,
          -18},{-92,-14},{-100,-14},{-100,0}}, color={0,0,0}));
