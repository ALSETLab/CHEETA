...
model DriveTrainPowerSystem_Battery
  ...
  ElectrifiedPowertrains.SupplySystem.Batteries.Blocks.EnergyAnalysis energyAnalysis(
    ...
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-80,22})));
  ElectrifiedPowertrains.SupplySystem.Batteries.Packs.DC packDC(startSOC=1,
      redeclare
      ElectrifiedPowertrains.SupplySystem.Batteries.Packs.Records.Data.DC.EIG20Ah_96s2p
  ...
  Aircraft.Controls.MasterSystemControl supervisoryControl
...
equation
  ...
  connect(packDC.p, dcdc.dc_p1)
    annotation (Line(points={{-46,28},{-38,28}}, color={0,0,255}));
  connect(dcdc.dc_n1, packDC.n)
    annotation (Line(points={{-38,16},{-46,16}}, color={0,0,255}));
  connect(energyAnalysis.batteryBus, packDC.batteryBus) annotation (Line(
      points={{-80,12},{-82,12},{-82,0},{-56,0},{-56,12}},
      color={0,255,0},
      thickness=0.5));
...
end DriveTrainPowerSystem_Battery;
