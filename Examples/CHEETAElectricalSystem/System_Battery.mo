...
model System_Battery
  ...
  Aircraft.Electrical.BusExt busExt1(nn=1, np=1)
    annotation (Placement(transformation(extent={{14,-36},{16,-16}})));
equation
  ...
  connect(HTS.pin_n, busExt.n[1])
    annotation (Line(points={{-11,20},{6,20},{6,3},{14,3}}, color={0,0,255}));
  connect(busExt.p[1], speedFOC_ESM.pin_p)
    annotation (Line(points={{16,0},{32,0},{32,-8},{38,-8}}, color={0,0,255}));
  connect(battery_FC_Charging.p1, busExt.n[2]) annotation (Line(points={{
          0.545455,-23.7647},{6,-23.7647},{6,-3},{14,-3}}, color={0,0,255}));
  connect(battery_FC_Charging.n1, busExt1.n[1]) annotation (Line(points={{
          0.545455,-30.8235},{7.27273,-30.8235},{7.27273,-26},{14,-26}}, color=
          {0,0,255}));
  connect(busExt1.p[1], ground1.p) annotation (Line(points={{16,-26},{24,-26},{
          24,-20},{28,-20},{28,-36}}, color={0,0,255}));
